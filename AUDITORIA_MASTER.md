...
| **Líneas de Código (Netas)** | 45699 LoC |
| **Peso Total del Proyecto** | 2.30MB |
| **Archivos analizados** | 138 |
| **Timestamp** | 2026-09-12 01:01 |
| **Estado** | Activa |
...
| :--- | ---: | ---: | ---: | ---: | ---: |
| `modulos` | 26 | 10509 | 0 | 539.54KB | 23.0% ████ |
| `roadmap` | 12 | 8817 | 0 | 490.72KB | 19.3% ███ |
| `vistas` | 18 | 6550 | 0 | 339.16KB | 14.3% ██ |
| `vistas` | 19 | 3988 | 300 | 211.03KB | 8.7% █ |
| `config` | 10 | 2944 | 0 | 160.15KB | 6.4% █ |
| `capas` | 3 | 2351 | 0 | 116.16KB | 5.1% █ |
| `aprendizaje` | 17 | 2263 | 0 | 111.15KB | 5.0%  |
| `css` | 4 | 1886 | 0 | 63.71KB | 4.1%  |
| `css` | 4 | 1253 | 165 | 44.29KB | 2.7%  |
| `js` | 3 | 1099 | 0 | 57.96KB | 2.4%  |
| `nucleo` | 5 | 734 | 0 | 51.09KB | 1.6%  |
| `datos` | 1 | 604 | 0 | 20.99KB | 1.3%  |
| `js` | 1 | 485 | 89 | 30.13KB | 1.1%  |
| `cargas` | 1 | 183 | 0 | 11.65KB | 0.4%  |
| `adr` | 2 | 121 | 0 | 6.51KB | 0.3%  |
| `practica` | 3 | 94 | 12 | 3.08KB | 0.2%  |
| `docs` | 1 | 59 | 0 | 4.19KB | 0.1%  |
| `assets` | 1 | 14 | 0 | 791.00B | 0.0%  |
| **TOTAL** | — | **45699** | — | **2.30MB** | 100% |
...
| :--- | ---: | ---: | ---: |
| `.js` | 68 | 24911 | 1.28MB |
| `.md` | 35 | 12032 | 651.42KB |
| `.html` | 21 | 4482 | 239.73KB |
| `.css` | 8 | 3139 | 108.00KB |
| `.json` | 3 | 642 | 21.81KB |
| `.py` | 1 | 435 | 23.00KB |
...
│   ├── cargas/ [11.65KB]
│   │   └── datos-ejemplo.js (183 LoC | 11.65KB) [32 comentarios]
│   ├── config/ [160.15KB]
...
│   ├── nucleo/ [51.09KB]
│   │   ├── almacenamiento.js (197 LoC | 11.97KB) [126 comentarios]
...
│       ├── catalogos-vista.js (529 LoC | 25.71KB) [53 comentarios]
...
│       ├── documentos-vista.js (543 LoC | 34.56KB) [119 comentarios]
